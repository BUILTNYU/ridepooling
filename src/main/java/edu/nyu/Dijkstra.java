...
public class Dijkstra {
     ...
     */
    public static <T> HashMap<Map<T, Double>, Map<T, T>> shortestPaths(DirectedGraph<T> graph, T source, T sink) {
        ...
        while (!pq.isEmpty()) {
            ...
            /* finish run if sink is found. */
            if (curr.getValue().equals(sink)){
                break;
            }
